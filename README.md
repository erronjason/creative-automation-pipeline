...
```bash
pip install -e ".[dev]"
pytest          # 77 tests, ~4 min; covers schema, legal, saliency, reframing, rendering,
...
- The **Tidewell** brand and logos are fictional and generated by `scripts/make_sample_assets.py`. The packshot (`assets/sparkling-yuzu/hero.png`) and the images the mock replays are real gpt-image-2 generations. The font is Poppins (SIL OFL).
